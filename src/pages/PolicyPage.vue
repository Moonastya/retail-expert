    ...
    <section class="policy-section">
      <div class="container">
        ...
        <p>
          ...
          обработки персональных данных и меры по обеспечению безопасности персональных данных ООО
          "Ритейл Эксперт" (далее – Оператор).
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            или определяемому Пользователю веб-сайта https://r-ex.ru/;
          </li>
          <li>Пользователь – любой посетитель веб-сайта https://r-ex.ru/;</li>
          <li>
        ...
        <ol>
          ...
          <li>
            ...
            электронной почты Info@p-analitika.ru с пометкой «Отказ от уведомлениях о новых
        ...
        <ol>
          <li>
            ...
            сайте https://r-ex.ru/. Заполняя соответствующие формы и/или отправляя свои персональные
        ...
        <ol>
          ...
          <li>
            ...
            Оператора Info@p-analitika.ru с пометкой «Актуализация персональных данных».
          </li>
          <li>
            ...
            Info@p-analitika.ru с пометкой «Отзыв согласия на обработку персональных данных».
          </li>
        </ol>
